...
function requireSignIn() {
  root.innerHTML = `
    <div class="empty" style="grid-column:1/-1;padding:90px 20px">
      ...
      ${isLive ? `<a class="btn btn-primary" href="auth.html">Sign in</a>` : `<a class="btn btn-primary" href="mods.html">Browse demo mods</a>`}
    </div>`;
}
...
async function render() {
  ...
  const libraryHtml = purchases.length
    ...
    : `<div class="empty" style="padding:40px 20px">
         ...
         <a class="btn btn-outline btn-sm" href="mods.html">Browse mods</a>
       </div>`;
